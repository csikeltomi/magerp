...
RegisterServerEvent('InteractSound_SV:PlayWithinDistanceCoords')
AddEventHandler('InteractSound_SV:PlayWithinDistanceCoords', function(maxDistance, soundFile, soundVolume,coords)
    TriggerClientEvent('InteractSound_CL:PlayWithinDistanceOS', -1, coords, maxDistance, soundFile, soundVolume)
end)