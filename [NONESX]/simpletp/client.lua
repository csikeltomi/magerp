...
positions = {
    ...
    ['1'] = {{1867.42, 3666.11, 32.80, 0}, {1863.09, 3673.94, 33.1, 0},{36,237,157}, "First Teleport"}, -- Outside the Sheriff's Station
    --['2'] = {{67.853378295898,1573.7103271484,6.6191921234131, 0}, {-259.31881713867,1707.3923339844,105.64498138428, 0},{36,237,157}, "First Teleport"}, -- Outside the Sheriff's Station
}
...
RegisterNetEvent('TELEPORT:RegisterPortal')
AddEventHandler('TELEPORT:RegisterPortal',function(name,coords,coords2)
    positions[name] = {{coords.x,coords.y,coords.z-1,0},{coords2.x,coords2.y,coords2.z-1,0},{36,237,157}, name}
    --print(dump(positions[name]))
end)


RegisterNetEvent('TELEPORT:RemovePortal')
AddEventHandler('TELEPORT:RemovePortal',function(name)
    positions[name] = nil
end)
