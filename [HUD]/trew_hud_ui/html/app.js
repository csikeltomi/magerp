...
window.onload = function () {
		...
		var eventCallback = {
			ui: function(data) {
				...
				else if (config.showServerLogo == false) { document.querySelector('.info.player').style.bottom = '10px'; }
				...
				if (config.showJob == true) { document.querySelector('#job').style.display = 'block'; document.querySelector('#jobGrade').style.display = 'block'; }
