...
const info = {
    default: 'Jelölj ki egy helyet további infóhoz.',
    change: 'Kattint az öltözéshez.',
    empty: 'Kattints a szerkerszét gombra a mentéshez.',
    editbutton: 'Szerkesztés.',
    clearbutton: 'Kiürítés.',
    confirmbutton: 'Megerősít.',
    cancelbutton: 'Elutasít.',
    closebutton: 'Bezárás.'
};
