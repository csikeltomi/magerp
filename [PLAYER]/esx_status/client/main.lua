...
RegisterNetEvent('esx_basicneeds:Loaded')
AddEventHandler("esx_basicneeds:Loaded", function (status)
	for i=1, #Status, 1 do
		for j=1, #status, 1 do
...
RegisterNetEvent('esx_status:ForceLoad')
AddEventHandler('esx_status:ForceLoad', function()
	--TriggerEvent('esx_status:loaded')
end)
