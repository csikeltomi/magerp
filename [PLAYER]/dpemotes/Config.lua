...
Config.Languages = {
  ['hu'] = {
        ['emotes'] = 'Gesztusok',
        ['danceemotes'] = "🕺 Tánc Gesztusok ",
        ['propemotes'] = "📦 Tárgyas Gesztusok",
        ['favoriteemotes'] = "🌟 Kedvencek",
        ['favoriteinfo'] = "Válassz ki itt egy gesztust hogy a kedvencekhez addhasd. ",
        ['rfavorite'] = "Kedvencek ",
        ['prop2info'] = "❓ Tárgyas Gesztusokat megtalálod a felsorolás végén",
        ['set'] = "Beállítsuk ezt (",
        ['setboundemote'] = ") a visszatérö gesztusodnak?",
        ['newsetemote'] = "~w~  nyomd le a ~g~CapsLock~w~-t .",
        ['cancelemote'] = "Gesztus Megszakítása",
        ['cancelemoteinfo'] = "~r~X~w~ Lenyomásával megszakítod az éppen történö gesztust.",
        ['walkingstyles'] = "Járás Stílus",
        ['resetdef'] = "Visszaállítás alaphelyzetbe",
        ['normalreset'] = "Alapértelmezett (Visszaállítás)",
        ['moods'] = "Arckifejezések",
        ['infoupdate'] = "Információ",
        ['infoupdateav'] = "Információ (Frissítés Elérhetö)",
        ['infoupdateavtext'] = "Egy Frissítés elérhető, innen elérheted a legfrisebb változatot ~y~https://github.com/andristum/dpemotes~w~",
        ['suggestions'] = "Javaslatok?",
        ['suggestionsinfo'] = "'dullpear_dev' A FiveM forumon cím ha van valami probléma/gesztus javaslat! ✉️",
        ['notvaliddance'] = "Ez nem egy megfelelő tánc gesztus.",
        ['notvalidemote'] = "Ez nem egy megfelelő gesztus.",
        ['nocancel'] = "Nincs gesztus amit meglehetne szakítani.",
        ['maleonly'] = "Ez a gesztus Férfi gesztus, bocsánat!",
        ['emotemenucmd'] = "Írd a chatbe hogy /emotemenu a gesztus menühöz.",
        ['shareemotes'] = "👫 Közös Gesztusok",
        ['shareemotesinfo'] = "Kérjfel valakit a közeledben egy közös gesztushoz",
        ['sharedanceemotes'] = "🕺 Közös Táncok",
        ['notvalidsharedemote'] = "Ez nem egy megfelelő közös gesztus.",
        ['sentrequestto'] = "A Felkérés elküldve ~y~ számára",
        ['nobodyclose'] = "Nincs senkisem elég ~r~közel~w~.",
        ['doyouwanna'] = "~y~Y~w~ Hogy elfogadd, ~r~L~w~ Hogy elutasítsd a (~g~",
        ['refuseemote'] = "Gesztus Elutasítva.",
        ['makenearby'] = "makes the nearby player play",
        ['camera'] = "Nyomd le a ~y~G~w~-t hogy használd a kamera vakuját.",
        ['makeitrain'] = "Nyomd le ~y~G~w~-t hogy esőt csinálj.",
        ['pee'] = "Tartsd lenyomva a ~y~G~w~-t hogy pisilj.",
        ['spraychamp'] = "Tartsd lenyomva a ~y~G~w~-t a pezsgő áradathoz.",
        ['bound'] = "Visszatérő",
        ['to'] = "nak",
        ['currentlyboundemotes'] = "Jelenlegi Visszatérő gesztusaid:",
        ['notvalidkey'] = "Ez nem egy megfelelő kulcs.",
        ['keybinds'] = "🔢 Gyorsgombok",
        ['keybindsinfo'] = "Használatra"
  },
  ['fr'] = {
        ['emotes'] = 'Emotes',
