...
MySQL.ready(function()
	MySQL.Async.fetchAll('SELECT items.label,shops.item,shops.store,shops.price,items.name FROM shops LEFT JOIN items ON items.name = shops.item', {}, function(shopResult)
