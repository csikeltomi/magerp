...
AddEventHandler('esx_lscustom:installMod', function()
	...
	TriggerServerEvent("esx_lscustom:SaveMods", myCar, OriginalVehicle,GetVehicleNumberPlateText(vehicle))
	TriggerEvent("SepruMenu:UpdateCurrent", myCar,GetVehicleNumberPlateText(vehicle))
end)
...
function OpenLSMenu(elems, menuname, menutitle, parent)
	local original = GetVehiclePedIsIn(GetPlayerPed(-1), false)
	OriginalVehicle = ESX.Game.GetVehicleProperties(original)
	ESX.UI.Menu.Open(
