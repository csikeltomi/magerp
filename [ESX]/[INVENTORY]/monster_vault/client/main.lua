...
Citizen.CreateThread(function()
	while true do
		...
		for k,v in pairs(Config.Vault) do
			...
			if dist < 2 then
				ESX.ShowHelpNotification("[E] Tároló")
...
Citizen.CreateThread(function ()
	while true do
		local object = GetClosestObjectOfType(253.25080871582,223.99935913086,101.89915466309, 10.0, 961976194, false, false, false)
		SetEntityRotation(object, 0.1, 0.0, 0.0, 1, false)
		Wait(5000)
	end
end)
