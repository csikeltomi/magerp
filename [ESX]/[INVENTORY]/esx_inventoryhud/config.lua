...
Config.JobOnlyInventory = false -- True means that if your police or ambulance you can search players, false means anyone can search players

-- List of item names that will close ui when used
Config.CloseUiItems = {"B_0_ALOHOMORA_1",
"B_0_BLOWAROUND-SMOKE_1",
"B_0_INVITO_1",
"B_0_LUMOS_1",
"B_0_TELEPORT2_1",
"B_0_TELEPORT_1",
"B_10_BLOWAROUND-EXPLOSION_1",
"B_10_BLOWAROUND-FIRE_1",
"B_10_BLOW_1",
"B_1_STUN_1",
"B_1_WATER_1",
"B_2_REVIVE_1"
...
Config.Shops = {
	...
	Casino = {
	Locations = {
		{x = 1115.69, y = 219.94, z = -50.43},
	
        },
        Items = {
            {name = 'cchip'}, -- add more items here
        }
	},
	Hospital = {
	Locations = {
		{x = 307.95056152344, y = -593.0859375, z = 42.28409576416},
	
        },
        Items = {
            {name = 'bandage'}, -- add more items here
        }
	},
--[[
    YouTool = {
