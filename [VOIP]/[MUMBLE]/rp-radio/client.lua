...
Radio.Labels = {        
    { "FRZL_RADIO_HELP", "~s~" .. (radioConfig.Controls.Secondary.Enabled and "~" .. radioConfig.Controls.Secondary.Name .. "~ + ~" .. radioConfig.Controls.Activator.Name .. "~" or "~" .. radioConfig.Controls.Activator.Name .. "~") .. " az elrejtéshez.~n~~" .. radioConfig.Controls.Toggle.Name .. "~ ~g~BE~s~ álláshoz.~n~~" .. radioConfig.Controls.Decrease.Name .. "~ vagy ~" .. radioConfig.Controls.Increase.Name .. "~ frekvenciaváltáshoz~n~~" .. radioConfig.Controls.Input.Name .. "~ a frekvencia beírásához~n~~" .. radioConfig.Controls.ToggleClicks.Name .. "~ a hangjelzések ~a~ ~n~Frekvencia: ~1~ MHz" },
    { "FRZL_RADIO_HELP2", "~s~" .. (radioConfig.Controls.Secondary.Enabled and "~" .. radioConfig.Controls.Secondary.Name .. "~ + ~" .. radioConfig.Controls.Activator.Name .. "~" or "~" .. radioConfig.Controls.Activator.Name .. "~") .. " az elrejtéshez.~n~~" .. radioConfig.Controls.Toggle.Name .. "~ ~r~KI~s~ álláshoz.~n~~" .. radioConfig.Controls.Broadcast.Name .. "~ beszédhez.~n~Frequency: ~1~ MHz" },
    { "FRZL_RADIO_INPUT", "Add meg frekvenciát" },
}
Radio.Commands = {
    {
...
Citizen.CreateThread(function()
    ...
    while true do
        ...
        if ESX.PlayerData.job.name == 'police' or ESX.PlayerData.job.name == 'swat' then 
            GivePlayerAccessToFrequency(2)
            GivePlayerAccessToFrequency(112)
        else
            RemovePlayerAccessToFrequencies(1, 2,112)
        end
    end
    ...
    while true do
        ...
        if Radio.Open then
            ...
            if not Radio.On then
                AddTextComponentSubstringPlayerName(Radio.Clicks and "~r~kikapcsolásához~w~" or "~g~bekapcsolásához~w~")
            end
