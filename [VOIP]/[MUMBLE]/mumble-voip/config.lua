...
mumbleConfig = {
	...
	voiceModes = {
		{2.5, "Suttogás"}, -- Whisper speech distance in gta distance units
		{8.0, "Átlagos"}, -- Normal speech distance in gta distance units
		{20.0, "Kiabálás"}, -- Shout speech distance in gta distance units
		{80.0, "Hangosbeszélö"}, -- Shout speech distance in gta distance units
	},
