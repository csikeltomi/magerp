Locales['en'] = {
  ...
  ['you_have_this_magic'] = 'Már van egy ilyen varázslatod!',
  ['gave_item'] = 'Átadtál ~y~%sx~s~ ~b~%s~s~ -> ~y~%s~s~',
  ['received_item'] = 'Kaptál ~y~%sx~s~ ~b~%s~s~ töle: ~b~%s~s~',
  ['gave_weapon'] = 'Átadtál ~b~%s~s~ -> ~y~%s~s~',
  ['gave_weapon_ammo'] = 'Átadtál ~o~%sx %s~s~ for ~b~%s~s~ -> ~y~%s~s~',
  ['gave_weapon_withammo'] = 'Átadtál ~b~%s~s~ with ~o~%sx %s~s~ -> ~y~%s~s~',
  ...
  ['received_weapon_ammo'] = 'Kaptál ~o~%sx %s~s~ for your ~b~%s~s~ töle ~b~%s~s~',
  ['received_weapon_withammo'] = 'Kaptál ~b~%s~s~ with ~o~%sx %s~s~ töle ~b~%s~s~',
  ['received_weapon_hasalready'] = '~b~%s~s~ attempted -> give you a ~y~%s~s~, but you already have one',
  ['received_weapon_noweapon'] = '~b~%s~s~ attempted -> give you ammo for a ~y~%s~s~, but you dont have one',
  ['gave_account_money'] = 'Átadtál ~g~€%s~s~ (%s) -> ~y~%s~s~',
  ['received_account_money'] = 'Kaptál ~g~€%s~s~ (%s) töle ~b~%s~s~',
  ['amount_invalid'] = 'invalid amount',
  ['players_nearby'] = 'Nincs játékos a közeledben',
  ['ex_inv_lim'] = 'Túl sok tárgy van a zsebedben ~y~%s~s~',
  ['imp_invalid_quantity'] = 'Érvénytelen mennyiség',
  ['imp_invalid_amount'] = 'Érvénytelen mennyiség',
  ['threw_standard'] = 'Eldobtad ~y~%sx~s~ ~b~%s~s~',
  ['threw_account'] = 'Eldobtad ~g~€%s~s~ ~b~%s~s~',
  ['threw_weapon'] = 'Eldobtad ~b~%s~s~',
  ['threw_weapon_ammo'] = 'Eldobtad ~b~%s~s~ with ~o~%sx %s~s~',
  ['threw_weapon_already'] = 'you already carry the same weapon',
  ['threw_cannot_pickup'] = 'Nem tudod felvenni, nincs nálad elég hely!',
  ['threw_pickup_prompt'] = 'Nyomj ~y~E~s~-t a felvételhez',

  -- Key mapping
  ['keymap_showinventory'] = 'show Inventory',

  -- Salary related
  ['received_salary'] = 'Fizetés kaptál: ~g~€%s~s~',
  ['received_help'] = 'Megkaptad a segélyt: ~g~€%s~s~',
  ['company_nomoney'] = 'A vállalat ahol dolgozol nem tudja fizetni az alkalamazottakat.',
  ['received_paycheck'] = 'Számlát kaptál',
  ['bank'] = 'maze Bank',
  ['account_bank'] = 'bank',
  ['account_black_money'] = 'Piszkos pénz',
  ['account_money'] = 'Galleon',

  ['act_imp'] = 'Ez nem lehetséges',
  ['in_vehicle'] = 'Ez nem teheted, mert a másik személy egy gépjármüben ül.',
  ...
  ['command_giveaccountmoney_amount'] = 'amount -> add',
  ['command_giveaccountmoney_invalid'] = 'invalid account name',
  ['command_giveitem'] = 'give an item -> a player',
  ['command_giveitem_item'] = 'item name',
  ['command_giveitem_count'] = 'item count',
  ['command_giveweapon'] = 'give a weapon -> a player',
  ...
  ['command_save'] = 'save a player -> database',
  ['command_saveall'] = 'save all players -> database',
  ['command_setaccountmoney'] = 'set account money for a player',
  ['command_setaccountmoney_amount'] = 'amount of money -> set',
  ['command_setcoords'] = 'teleport -> coordinates',
  ...
  ['commanderror_console'] = 'that command cannot be run töle console',
  ...
  ['weapon_flaregun'] = 'Varázspálca - Főnix toll',
  ...
  ['weapon_flare'] = 'Varázspálca - Főnix toll',
